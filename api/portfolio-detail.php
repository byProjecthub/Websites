...
if (empty($project)) {
    $fallbacks = [
        'finlytics-dashboard' => [
            ...
            'gallery' => ['assets/images/placeholder.svg', 'assets/images/placeholder.svg'],
            'tech_stack' => ['React', 'Node.js', 'PostgreSQL', 'Redis', 'AWS', 'Docker'],
            'live_url' => '#',
            'github_url' => '#',
            'results' => ['56% faster load times', '99.9% uptime', '500K+ daily transactions'],
        ...
        'reloventura-platform' => [
            ...
            'live_url' => '#',
            'github_url' => '#',
            'results' => ['3x booking conversion', 'R2M+ processed', 'Zero downtime deployment'],
        ...
        'enterprise-etl-pipeline' => [
            ...
            'long_description' => 'A cloud-native ETL pipeline built for a logistics enterprise. The system ingests data from 15+ sources including IoT sensors, ERP systems, and third-party APIs. It cleanses and transforms data using Apache Spark, and loads it into Snowflake for analytics.',
            'service_type' => 'Data Engineering',
            'client_name' => 'LogiTech SA',
            'image' => 'assets/images/placeholder.svg',
            'gallery' => ['assets/images/placeholder.svg', 'assets/images/placeholder.svg'],
            'tech_stack' => ['Python', 'Apache Spark', 'Snowflake', 'Airflow', 'AWS Glue', 'Kafka'],
            'live_url' => '#',
            'github_url' => '#',
            'results' => ['2M+ records/day', '85% cost reduction', 'Real-time reporting'],
            'testimonial' => 'I think Njabulo was essential to our product because he truly cared to deliver world-class work results',
            'year' => '2024',
        ],
